...
@section('content')
    ...
    <section class="border-y border-rose-100 bg-white">
        <div class="mx-auto grid max-w-7xl gap-px px-4 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
            @foreach ([['icon' => '♡', 'title' => 'Request custom buket', 'description' => 'Pesan kartu dan catatan florist'], ['icon' => '✦', 'title' => 'Kartu ucapan gratis', 'description' => 'Untuk setiap pesanan buket'], ['icon' => '⌑', 'title' => 'Bayar dengan mudah', 'description' => 'QRIS atau transfer bank'], ['icon' => '⌁', 'title' => 'Lacak pesanan', 'description' => 'Pantau status pengirimanmu']] as $benefit)
    ...
    <section id="koleksi" class="scroll-mt-20 bg-white py-20 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                @foreach ([['title' => 'Untuk Merayakan', 'image' => 'photo-1523438885200-e635ba2c371e'], ['title' => 'Untuk Mengungkapkan', 'image' => 'photo-1490750967868-88aa4486c946'], ['title' => 'Untuk Menguatkan', 'image' => 'photo-1561181286-d3fee7d55364'], ['title' => 'Untuk Hari Spesial', 'image' => 'photo-1582794543139-8ac9cb0f7b11']] as $collection)
