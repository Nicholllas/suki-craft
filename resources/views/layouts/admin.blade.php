    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-rose-100 bg-[#fffdf9] shadow-2xl shadow-stone-900/10 transition-transform duration-300 lg:translate-x-0" aria-label="Navigasi admin">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-5">
            ...
            <div class="space-y-1">
                ...
                <x-admin.nav-link :href="route('admin.orders.index')" :active="request()->routeIs('admin.orders.*')"><svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 3.75h9l3 3v13.5H4.5V6.75l3-3ZM8.25 10.5h7.5m-7.5 3h7.5m-7.5 3h4.5" /></svg>Pesanan<span class="ml-auto rounded-full bg-amber-100 px-2 py-0.5 text-[10px] font-bold text-amber-700">0</span></x-admin.nav-link>
            </div>
        ...
        <header class="sticky top-0 z-30 border-b border-stone-200/80 bg-[#fbfaf7]/90 backdrop-blur">
            <div class="flex h-20 items-center gap-3 px-4 sm:px-6 lg:px-8">
                ...
                <div class="ml-auto flex items-center gap-2 sm:gap-3">
                    ...
                    <div class="relative" @click.outside="notificationsOpen = false"><button @click="notificationsOpen = !notificationsOpen" :aria-expanded="notificationsOpen" class="relative grid h-11 w-11 place-items-center rounded-xl border border-stone-200 bg-white text-stone-600 transition hover:border-rose-200 hover:text-rose-600" aria-label="Notifikasi"><svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M14.25 18.75h-4.5m9-2.25H5.25l1.5-2.25v-4.5a5.25 5.25 0 0 1 10.5 0v4.5l1.5 2.25Z" /></svg><span class="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-rose-500 ring-2 ring-white"></span></button><div x-cloak x-show="notificationsOpen" x-transition.origin.top.right class="absolute right-0 mt-3 w-80 overflow-hidden rounded-2xl border border-stone-100 bg-white shadow-xl shadow-stone-900/10"><div class="flex items-center justify-between border-b border-stone-100 px-4 py-3"><p class="text-sm font-semibold">Notifikasi</p><span class="rounded-full bg-rose-50 px-2 py-0.5 text-[10px] font-bold text-rose-600">2 baru</span></div><div class="p-3"><div class="rounded-xl bg-amber-50 p-3 text-sm"><p class="font-semibold text-amber-800">Belum ada pesanan baru</p><p class="mt-1 text-xs leading-5 text-amber-700">Notifikasi pesanan dan stok akan muncul di sini.</p></div></div></div></div>
